...
const Footer = () => {
  return (
    <footer className="py-12 bg-[#023047] sm:py-16 lg:py-20">
      <div className=" mx-auto sm:px-6 lg:px-8 max-w-[1440px]">
            ...
            <ul className="flex items-center mt-8 space-x-3">
              <li>
                <a
                  href="#"
                  title=""
                  className="inline-flex items-center justify-center p-2 text-white transition-all duration-200 bg-transparent border border-gray-300 rounded-full hover:bg-gray-900 hover:border-gray-900 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                >
                  <svg
                    className="w-5 h-5"
        ...
        <div className="mt-8 text-center">
          <p className="text-sm font-normal leading-6 text-white">
            © Copyright 2022, All Rights Reserved by Landingfolio
          </p>
        </div>
      </div>
    </footer>
